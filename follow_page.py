...
class Follow_Page:
    def __init__(self, master):
        ...
        status_entry.grid(row=0, column=1, padx=5, pady=5, sticky=NW)
        ...
        follow_by_entry.grid(row=1, column=1, padx=5, pady=5, sticky=NW)
        ...
        follow_info_text.grid(row=2, column=1, padx=5, pady=5, sticky=NW, columnspan=2)
